    ...
    public class BackgroundColorCamInfraredImage : MonoBehaviour
    {
        ...
        void Update()
        {
            if (kinectManager && kinectManager.IsInitialized())
            {
                ...
                if (infraredImageTexture != null && backgroundTexture != null)
                {
                    Vector2 imageScale = sensorData.colorImageScale;
                    KinectInterop.TransformTexture(infraredImageTexture, backgroundTexture, 0, imageScale.x < 0f, imageScale.y < 0f, backgroundCamera == null);
                }
        ...
        private void UpdateTextureWithNewFrame()
        {
            ...
            if (lastColorCamInfraredFrameTime != sensorData.lastColorCamInfraredFrameTime)
            {
                ...
                if (infraredImageTexture == null || infraredImageTexture.width != sensorData.colorImageWidth || infraredImageTexture.height != sensorData.colorImageHeight)
                {
                    infraredImageTexture = KinectInterop.CreateRenderTexture(infraredImageTexture, sensorData.colorImageWidth, sensorData.colorImageHeight);
                }
