...
namespace com.rfilkov.kinect
{
    ...
    public interface DepthSensorInterface
    {
        ...
        void EnableColorCameraObjectIndexFrame(KinectInterop.SensorData sensorData, bool isEnable);

        // returns the latest color camera object-index frame along with the last frame time
        byte[] GetColorCameraObjectIndexFrame(KinectInterop.SensorData sensorData, ref byte[] copyToFrame, ref ulong frameTime);
    }
}
