...
namespace com.rfilkov.kinect
{
    ...
    public enum NetMessageType : int { Control = 0, Color = 1, Depth = 2, Infrared = 3, BodyData = 4, BodyIndex = 5, Pose = 6, Depth2Color = 7, Color2Depth = 8, Color2BodyIndex = 9, Color2Infrared = 10, ObjectData = 11, ObjectIndex = 12, Color2ObjectIndex = 13 }
    // frame encode type
    public enum FrameEncodeType : int { None = 0, Raw = 1, Jpeg = 2, K4b = 3, Json = 4, SensorDataJson = 5, DSTraw = 6, CSTraw = 7, Compressed = 8, K4o = 9 };
    ...
    internal class NetMessageData
    {
        ...
        {
            return $"{timestamp}-{msgType} w:{frameWidth}, h:{frameHeight}";
        }
