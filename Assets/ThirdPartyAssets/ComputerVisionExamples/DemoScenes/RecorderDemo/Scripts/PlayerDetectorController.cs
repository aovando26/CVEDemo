...
namespace com.rfilkov.components
{
    ...
    public class PlayerDetectorController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //Debug.Log($"trackedBodiesCount: {sensorData.trackedBodiesCount}, lastUserTime: {lastUserTime}\ndeltaTime: {(Time.realtimeSinceStartup - lastUserTime):F3}, userFound: {bUserFound}");
