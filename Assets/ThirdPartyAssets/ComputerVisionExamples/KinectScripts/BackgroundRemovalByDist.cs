...
namespace com.rfilkov.kinect
{
    ...
    public class BackgroundRemovalByDist : MonoBehaviour
    {
        ...
        public void ApplyVertexFilter(RenderTexture vertexTexture, RenderTexture alphaTexture, Matrix4x4 sensorWorldMatrix)
        {
            ...
            Vector3 posMaxZ = new Vector3(xMin, yMin, zMax) - posMin;  // (posMaxZLeft + posMaxZRight) / 2;
            ...
            foregroundFilterShader.SetVector("_PosMaxZLeft", posMaxZ);  // posMaxZLeft);
            foregroundFilterShader.SetVector("_PosMaxZRight", posMaxZ);  // posMaxZRight);
