...
namespace com.rfilkov.components
{
    ...
    public class BackgroundStaticImage : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (backgroundImage.texture != null && backgroundTexture != null)
            {
                KinectInterop.TransformTexture(backgroundImage.texture, backgroundTexture, 0, false, false, backgroundCamera == null);
            }
        }
